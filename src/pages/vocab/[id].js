...
export default function Vocab() {
  let vocab = {
    cards: [
      ...
      {
        front: "to design a program",
        back: "architect",
        sentence: "He architected the project keeping scalability in mind.",
        vocabImg: "/vocab/danial-igdery-FCHlYvR5gJI-unsplash.jpg",
        audioPath: "/dummy-audio.mp3",
      },
    ],
  };
      ...
      <Flex direction="column" align="center">
        ...
        <Flex justify="center" gridGap={3} mb={10}>
          ...
          <Button
            onClick={getNext}
            color="white"
            colorScheme={index < cards.length - 1 ? "teal" : ""}
          >
            Next
